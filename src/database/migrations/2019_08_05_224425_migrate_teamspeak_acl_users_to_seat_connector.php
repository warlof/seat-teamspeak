...
/**
 * Class MigrateTeamspeakAclUsersToSeatConnector.
 */
class MigrateTeamspeakAclUsersToSeatConnector extends Migration
{
    public function up()
    {
        if (Schema::hasTable('teamspeak_group_users')) {

            echo 'Converting old teamspeak users policy structure to new seat-connector policies scheme...' . PHP_EOL;
