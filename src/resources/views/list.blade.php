          ...
          <table class="table table-condensed table-hover table-responsive">
            ...
            @foreach($group_users as $group)
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    <a href="{{ route('teamspeak.user.remove', ['user_id' => $group->group_id, 'group_id' => $group->teamspeak_sgid]) }}"
                       type="button" class="btn btn-danger btn-xs col-xs-12">
                      {{ trans('web::seat.remove') }}
                    </a>
                  </div>
          ...
          <table class="table table-condensed table-hover table-responsive">
            ...
            @foreach($group_roles as $group)
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    <a href="{{ route('teamspeak.role.remove', ['role_id' => $group->role_id, 'group_id' => $group->teamspeak_sgid]) }}"
                       type="button" class="btn btn-danger btn-xs col-xs-12">
                      {{ trans('web::seat.remove') }}
                    </a>
                  </div>
