...
namespace Warlof\Seat\Connector\Drivers\Teamspeak\Http\Middleware\Throttlers;
 ...
 *
 * @package Warlof\Seat\Connector\Drivers\Teamspeak\Http\Middleware\Throttlers
 */
class RateLimiterMiddleware
{
